//
//  ApplicationFeeMainViewController.m
//  WQZJ
//
...
@interface ApplicationFeeMainViewController ()

@end

@implementation ApplicationFeeMainViewController
...
- (void) loadSubviews{
    ...
    navigationBar.titleLabel.text = @"费用申请";
