//
//  VisitCustomerMainViewController.m
//  WQZJ
//
...
@interface VisitCustomerMainViewController ()

@end

@implementation VisitCustomerMainViewController
...
- (void) loadSubviews{
    ...
    navigationBar.titleLabel.text = @"客户拜访";
